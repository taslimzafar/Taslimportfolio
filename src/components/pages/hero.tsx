...
import { MdOutlineFileDownload } from "react-icons/md";
import { SiTypescript, SiReact, SiNextdotjs, SiTailwindcss, SiExpo, SiExpress, SiMongodb } from "react-icons/si";
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col">
          ...
          <RotatingText
            texts={['Full-Stack Developer', 'Next.js Developer', 'MERN Stack Developer']}
          ...
          <p 
            className="text-sm md:text-lg font-mono text-white hover:text-primary transition-colors flex items-center gap-1 mt-1"
          >
            Building projects with Next.js & MongoDB
          </p>
        </div>
      ...
      >
        ...
        <div className="flex items-center gap-2">
          ...
          <Link href="mailto:mdtaslimtk786@gmail.com" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">
            mdtaslimtk786@gmail.com
          </Link>
        </div>
        <div className="flex items-center gap-2">
          <span className="text-primary">📞</span>
          <Link href="tel:+919519542531" className="hover:text-primary transition-colors">
            +91-9519542531
          </Link>
        </div>
      </motion.div>
      ...
      >
        ...
        <span className={`${techHighlightClass} ${techHighlightVariants[2]}`}>
          <SiExpress className="text-gray-300" size={14} />
          Express.js
        </span>
        , and{" "}
        <span className={`${techHighlightClass} ${techHighlightVariants[3]}`}>
          <SiMongodb className="text-green-400" size={14} />
          MongoDB
        </span>
        . I enjoy building full-stack systems, REST APIs, and modern web
        platforms with a focus on clean UI and real-time functionality.
      </motion.p>
      ...
      >
        <Link
          href={"https://drive.google.com/file/d/1DQ8i00qHOc0eTo3d591cN4ioKoJkVEQU/view?usp=sharing"}
          rel="noopener noreferrer"
          target="_blank"
