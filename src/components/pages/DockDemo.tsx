...
const DATA = {
  ...
  social: [
    { name: "GitHub", url: "https://github.com/taslimzafar", icon: FaGithub },
    { name: "LinkedIn", url: "https://www.linkedin.com/in/md-taslim-developer/", icon: FaLinkedin },
    { name: "Email", url: "mailto:mdtaslimtk786@gmail.com", icon: Mail },
  ],
};
