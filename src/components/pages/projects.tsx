...
const projects = [
  {
    title: "Sahayak",
    description: "A full-stack crowdfunding platform enabling users to create fundraisers, accept donations, and track campaigns in real-time through an integrated Razorpay payment gateway.",
    image: "/sahayak_hero.jpg",
    link: "https://github.com/taslimzafar/newsahayakx",
    tech: ["Next.js", "Express.js", "MongoDB", "NextAuth", "Razorpay"],
  },
  {
    title: "RecipeFinder",
    description: "A responsive recipe search web app with multi-page navigation using the Forkify API.",
    image: "/recipe_hero.png",
    link: "https://github.com/taslimzafar/RecipeFinder",
    tech: ["React.js", "React Router", "Forkify API", "JavaScript", "Semantic UI"],
  },
  {
    title: "Sushi Restaurant Page",
    description: "A fully responsive restaurant landing page with smooth scroll-triggered animations and interactive UI.",
    image: "/sushi_hero.png",
    link: "https://github.com/taslimzafar/Sushi-Restaurant",
    tech: ["HTML5", "CSS3", "JavaScript", "ScrollReveal.js"],
  },
];
