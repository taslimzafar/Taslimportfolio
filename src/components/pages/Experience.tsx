  ...
  const timeline = [
    {
      ...
      details: [
        "Relevant Coursework: Data Structures & Algorithms, OOP, Operating Systems, DBMS, Artificial Intelligence, Computer Networks, UI/UX Design, Computer Architecture",
      ],
    },
  ];
